...
const Post: FC<IPosts> = ({
  ...
  if(price){
    priceContent = <div className="Post__corner">
      ...
      <div className="Post__links__container">
        <div className="Post__links__elements">
          <div className="Post__links__elements__like">
            <span className="Post__links__elements__icon">
              <MediaQuery query="(min-device-width: 576px)">
                <Icon type={liked ? 'liked' : 'desktop'} icon="like" clipPath={id} dataId={id} onClick={onLike.bind(null, id)}/>
              </MediaQuery>
              <MediaQuery query="(max-device-width: 575px)">
                <Icon type={liked ? 'liked' : 'mobile'} icon="like" clipPath={id} dataId={id} onClick={onLike.bind(null, id)}/>
              </MediaQuery>
            </span>
          ...
          <div className="Post__links__elements__repost">
            <span className="Post__links__elements__icon">
              <MediaQuery query="(min-device-width: 576px)">
                <Icon type="desktop" icon="repost" clipPath={id} dataId={id} onClick={rePost.bind(null, id)}/>
              </MediaQuery>
              <MediaQuery query="(max-device-width: 575px)">
                <Icon type="mobile" icon="repost" clipPath={id} dataId={id} onClick={rePost.bind(null, id)}/>
              </MediaQuery>
            </span>
